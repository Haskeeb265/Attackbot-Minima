...
from ...subdomain_domain_wildcards.passive.normalize import canonicalize_host, is_subdomain_of
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m service.recon_pipeline.asset_pipelines.url_endpoint.passive.pipeline",
        description=(
