...
from service.recon_pipeline.platform.common.docker_tool import DockerTimeoutError, DockerUnavailableError, docker_available, run_container
...
def run_docker_source(
    ...
    *,
    ...
    if not run.ok:
        from service.recon_pipeline.platform.common.docker_tool import read_tail
